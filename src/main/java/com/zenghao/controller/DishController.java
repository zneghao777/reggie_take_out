...
import com.zenghao.dto.DishDto;
import com.zenghao.entity.Category;
import com.zenghao.entity.Dish;
import com.zenghao.entity.DishFlavor;
import com.zenghao.service.CategoryService;
import com.zenghao.service.DishFlavorService;
...
public class DishController {
    ...
    public R<List<DishDto>> list(Dish dish) {
        ...
        //动态构造key
        String key = "dish" + dish.getCategoryId() + "_" + dish.getStatus();  //dish_CategoryId_1
        //先从redis 中获取缓存数据
